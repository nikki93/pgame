bootstrap:add {
  DOC[[ provide a viewport to visualize the world
...
bootstrap:add {
  DOC[[ the default camera for the main window ]],

  _name = 'main_camera',
  _protos = { 'camera' },
}

DOC[[ apply a transform that maps world-space coordinates to their coordinates
