bootstrap:add {
  DOC[[ may be notified of input events
...
bootstrap:add {
  DOC[[ is notified of input events
...
DOC[[ register love input callbacks for event names in '...', meant for internal
      use and is called automatically ]]
